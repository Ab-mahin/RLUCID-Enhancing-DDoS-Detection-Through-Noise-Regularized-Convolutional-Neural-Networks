...
# def balance_dataset(flows, total_fragments=float('inf')):
#     # Use all flows, optionally capped only by total_fragments
#     new_flow_list = []
#     current_fragments = 0

#     random.shuffle(flows)
#     for flow in flows:
#         frag_count = len(flow[1]) - 1
#         if current_fragments + frag_count > total_fragments:
#             break
#         new_flow_list.append(flow)
#         current_fragments += frag_count

#     # benign/ddos counts are not used later, set to 0
#     return new_flow_list, 0, 0
